...
/**
 * @file components/download/PlatformIcons.tsx
 * @description Brand glyphs for the download hub. lucide has no Apple/Android
 * marks, so these two stay hand-drawn SVGs shared by every download component.
 */
