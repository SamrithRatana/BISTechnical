...
export default function PrintPreviewSidebar({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/70 backdrop-blur-xs transition-opacity animate-in fade-in duration-200">
      {/* Sidebar Container */}
      <div className="w-full max-w-4xl bg-slate-900 h-full flex flex-col shadow-2xl overflow-hidden border-l border-slate-800">
        
        {/* Top Action Bar (Screen Only) */}
        <div className="px-6 py-3 bg-slate-900 border-b border-slate-800 flex items-center justify-between shrink-0 print:hidden text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold text-white flex items-center gap-2">
                Print Preview — <span className="font-mono text-blue-400">{currentItem.reportNo}</span>
              </h2>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-all shadow-md shadow-blue-500/20 active:scale-95 cursor-pointer"
            >
              <Printer className="w-4 h-4" />
        ...
        {/* Report Canvas Area */}
        <div className="flex-1 overflow-y-auto p-4 md:p-8 flex justify-center bg-slate-950 print:p-0 print:bg-white print:overflow-visible">
          ...
          >
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div>
                  <h1
                    className="text-base font-bold italic tracking-wide text-slate-600 uppercase"
            ...
            <div className="mt-auto pt-6 grid grid-cols-3 gap-6 text-center text-[10pt] text-black shrink-0">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[9.5pt] text-slate-800" style={{ fontFamily: "Arial, sans-serif" }}>Customer's signature</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[9.5pt] text-slate-800" style={{ fontFamily: "Arial, sans-serif" }}>Verify's signature</p>
                <p className="mt-1 font-semibold text-black">{currentItem.verifiedByName || currentItem.createdByName || "Seng KimNeang"}</p>
                <p className="text-[9.5pt] text-slate-800 font-mono">{currentItem.createdByPhone || "+855 16 221 237"}</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[9.5pt] text-slate-800" style={{ fontFamily: "Arial, sans-serif" }}>Engineer's signature</p>
                <p className="mt-1 font-semibold text-black">{currentItem.repairByName || "Sors Sokean"}</p>
                <p className="text-[9.5pt] text-slate-800 font-mono">{currentItem.repairByPhone || "+855 16 380 159"}</p>
              </div>
            </div>
        ...
        <div className="px-6 py-3 bg-slate-900 border-t border-slate-800 flex items-center justify-between shrink-0 print:hidden text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-2 px-5 py-1.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-all shadow-md shadow-blue-500/20 active:scale-95 cursor-pointer"
            >
              <Printer className="w-4 h-4" />
              <span>Print Report</span>
            </button>
